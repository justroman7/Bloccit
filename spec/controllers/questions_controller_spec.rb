...
RSpec.describe QuestionsController, type: :controller do
  ...
  describe "question create" do
    it "increases the number of question by 1" do
      expect{post :create, question: {title: RandomData.random_sentence, body: RandomData.random_paragraph, resolved: "0"}}.to change(Question,:count).by(1)
    end

    it "assigns the new question to @question" do
      post :create, question: {title: RandomData.random_sentence, body: RandomData.random_paragraph, resolved: "0"}
